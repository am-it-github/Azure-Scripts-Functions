...
$DateToDisable = (Get-Date).AddDays(-60)
...
$DevicestoDelete = Get-AzureADDevice -All:$true | Where {($_.DisplayName -notlike $DevExclusion1) -and ($_.DisplayName -notlike $DevExclusion2) -and ($_.DisplayName -notlike $DevExclusion3) -and ($_.ApproximateLastLogonTimeStamp -le $DateToDelete) -and ($_.AccountEnabled -eq $false) -and ($_.ApproximateLastLogonTimeStamp -ne $null)} 
