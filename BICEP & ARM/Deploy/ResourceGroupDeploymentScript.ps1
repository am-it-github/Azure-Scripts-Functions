...
Function DeploymentSettings {
    ...
    $Global:DepLocation = Read-Host "Please provide the Location for the Deployment Info (""UK South"" or ""UK West"")"
...
Function UsingParam {
  ...
  New-AzSubscriptionDeployment  -Name $DeploymentName -Location $DepLocation -TemplateFile $BicepFullPath -TemplateParameterFile $ParamFullPath
  }
Function NoParam {
DeploymentSettings
...
New-AzSubscriptionDeployment -Name $DeploymentName -Location $DepLocation -TemplateFile $BicepFullPath
